...
@app.get("/about")
def about() :
    return {"message" : "A fully functional API to manage all your patient records."}
...
def view_patient(patient_id : str = Path(..., description = "ID of the patient in the Database", example = "P001", gt = 0)) :
    data = load_data()
